...
scoreboard objectives remove aj.resetting_pillar.frame
scoreboard objectives remove aj.attack_stone_bricks.frame
scoreboard objectives remove aj.melee_pillar.frame
