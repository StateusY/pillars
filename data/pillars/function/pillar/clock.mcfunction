...
# states: pl.state_awakening, pl.state_idle, pl.state_attacking, pl.state_dying
...
# a pillar is given the dying state tag from an idle state tag in pillar/pillar_death/start_state_dying triggers